...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return loadMonthDetails(
        screenSize, context, userDatails, widget.currentMonth);
  }
  ...
  Column loadMonthDetails(Size screenSize, BuildContext context,
      AsiriUser userDetails, int currentMonth) {
    return Column(
      children: [
        MonthCongratsWidget(
        ...
        Center(
          child: Text(
            "$caption Month",
            style:
                TextStyle(fontSize: 24, color: Color.fromRGBO(255, 61, 227, 1)),
          ),
        ),
        SizedBox(
          height: 10,
        ...
        MonthSliderWidget(
          ...
          toggleNext: nextMonth,
          togglePrev: prevMonth,
        ),
        Container(
          child: monthlyContent,
        ),
      ],
    );
  }
