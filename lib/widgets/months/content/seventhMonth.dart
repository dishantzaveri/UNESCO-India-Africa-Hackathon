...
class SeventhMonthContent extends StatelessWidget {
  final String url =
      "https://firebasestorage.googleapis.com/v0/b/asiri-hospital-tour.appspot.com/o/videos%2F7th_Month_Maathota_1.mp4?alt=media&token=6a5d9811-7ac3-472f-9214-7c4d00dd348b";
  @override
          ...
          child: Column(
            children: [
              Paragraph(
                color: darkBlue,
                text:
                    "  You are now in the seventh month of your pregnancy. As you gradually get close to achieving wonderful motherhood, during this month as in the "
              ...
              Paragraph(
                color: darkBlue,
                text:
                    "  Most importantly, you should keep in mind that this is the last trimester in your pregnancy. "
                ...
                child: Column(
                  children: [
                    ...
                    Paragraph(
                      color: Colors.white,
                      text:
                          "  When you are seven months pregnant, your baby is busy developing the organs and systems that help sustain life outside the womb. For example, the baby's lungs begin to produce a fluid called "
                          "surfactant, which allows his lungs to expand and contract as required.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "  Your baby can now open and close his eyes. During this time, your baby will notice changes between light and "
                          "darkness and will respond to bright light by moving or kicking.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "  During this time, fat is deposited on the baby's wrinkles and the extra fat helps to soothe the baby's wrinkles. Meanwhile, the skin cells begin to produce the "
                          "pigment melanin, which gives the skin its natural color.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "  By the end of the month, the baby will weigh 3 pounds and its full length will be about 10 1/2 inches.",
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  children: [
                    ...
                    Paragraph(
                      color: Colors.orange,
                      text:
                          "  You need to pay special attention to the postpartum pain and mental conditions that occur during this last trimester. It is imperative that you are always happy and be "
                          "sure to tell your problems to your husband or to a trusted relative.",
                    ),
                    Paragraph(
                      color: Colors.orange,
                      text:
                          "  From this month onwards, there is a possibility of developing labor pains and childbirth at any time and therefore you should pay special attention to this possibility. You can always let your child listen to pleasing music. If you are doing a job it is better "
              ...
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "For a father, this is the time when you must be most vigilant. Try to get closer to your wife more and more. "
                    "Comfort the wife whenever possible and show her love and care all the time.",
              ),
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "You need to have a plan as to how you will act in case of the onset of labor pains or childbirth.  As a father, the time has come for you to think about the facilities "
