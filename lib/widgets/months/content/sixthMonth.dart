...
class SixthMonthContent extends StatelessWidget {
  final String url =
      "https://firebasestorage.googleapis.com/v0/b/asiri-hospital-tour.appspot.com/o/videos%2F6th_Month.mp4?alt=media&token=6a4e8489-ed4f-4186-b35d-8889867cf1b6";
  @override
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Paragraph(
                      color: Colors.white,
                      text:
                          "By the 24th week of pregnancy, your baby is growing rapidly and weighs about 600 grams. The height from head to toe is about 30 cm.The taste buds of the tongue continue to develop. The brain is developing rapidly and the brain cells, as "
                          "well as the inner ear, which are needed to maintain memory and alertness, are now completely developed.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "Although the baby has translucent skin, that condition will change very soon. We talked about this in the previous months. The baby's hair is white. That's because the melanin pigment has not yet been formed. The production of white blood "
                          "cells, which are needed to prevent infections, has now begun.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "Your baby's eyes are still closed, but from time to time, faint eyebrows flutter above the lids. When he is not asleep, your child may "
                          "respond to sound, especially to the sound of your voice.",
                    ),
                    Paragraph(
                      color: Colors.white,
                      text:
                          "By this month, your baby's lungs are fully formed. Of course, still there are a few conditions that need to be developed before the baby is ready to face the outside world. Your baby's sucking ability is improving, and the baby is "
              ...
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "By now, the baby inside the mother is more than five months old. That means more than half of the pregnancy is over. So now, little by little, start planning for the future with her. Design the room creatively. Let her see pleasing pictures of babies. "
                    "This will strengthen her mental health as well as her postpartum mood.",
              ),
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "Always keep her happy. Do not forget to maintain a peaceful environment at home. As everyone says, you are her most trusted partner.",
              ),
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "So pay as much attention to her as possible during this time and protect her from accidents.",
              ),
              Paragraph(
                color: Colors.pinkAccent,
                text:
                    "The result of the sacrifices you make during this time will be rewarded in the smile of a baby that will come soon.",
              ),
            ],
          ),
        ),
