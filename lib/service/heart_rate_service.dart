...
import 'package:mother_and_baby/service/responses/heart_rate_response.dart';
...
class HeartRateServer {
  ...
  Future<void> postHeartRate(
      {required HeartRate heartRate, required int partographId}) async {
    await _helper.postData(
        data: jsonEncode(heartRate.toMap()), url: "heartRate/$partographId");
  }
